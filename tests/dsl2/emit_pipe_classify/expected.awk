...
function handler(ctx,    raw, _ds_tc_1, _ds_err_type__ds_tc_1, _ds_p_1) {
  _ds_tc_1 = ctx::dispatch("req.form", "name")
  ...
  _ds_p_1 = strip(raw)
  ctx::dispatch("res.html", safe::dispatch("html.escape", _ds_p_1))
}
